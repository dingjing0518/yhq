    ...
    <div class="carManager">
        ...
        <el-dialog title="添加" :visible.sync="addVisible" width="30%">
            <el-form ref="addForm" :model="addForm" :rules="carFormRules" label-width="100px">
                ...
                <el-form-item label="进场时间" prop="jcoInboundTime">
                    <el-date-picker v-model="addForm.jcoInboundTime" type="datetime"
                                    placeholder="选择日期"></el-date-picker>
                </el-form-item>
                <el-form-item label="出场时间" prop="jcoDepartureTime">
                    <el-date-picker v-model="addForm.jcoDepartureTime" type="datetime"
                                    placeholder="选择日期"></el-date-picker>
                </el-form-item>
        ...
        <el-dialog title="修改用户权限" :visible.sync="editVisible" width="30%">
            <el-form ref="editForm" :model="editForm" label-width="100px">
                ...
                <el-form-item label="进场时间" prop="jcoInboundTime">
                    <el-date-picker v-model="editForm.jcoInboundTime" type="datetime"
                                    placeholder="选择日期"></el-date-picker>
                </el-form-item>
                <el-form-item label="出场时间" prop="jcoDepartureTime">
                    <el-date-picker v-model="editForm.jcoDepartureTime" type="datetime"
                                    placeholder="选择日期"></el-date-picker>
                </el-form-item>
                <el-form-item label="车类型" prop="jcoCarType">

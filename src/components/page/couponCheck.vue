        ...
        methods: {
            ...
            look(index, row) {
                ...
                if (time1 > time2) {
                    ...
                    this.addent = true;
                    // 优惠券二维码
                    this.link = "http://yun.jinshipark.com:81/addPlote.html?id=" + row.id + "&type=" + row.type + "&strSign=" + '6214A0' + "&strOrderID=" + "022020080415084601109";
            ...
            getData() {
                var res = this;
                this.$axios({
                    url: this.GLOBAL._SERVER_API_ + "shopCouponManager/list",
                    method: "post",
                    data: {
